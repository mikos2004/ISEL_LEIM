...
@WebServlet("/ArrumarVeiculo17")
public class ArrumarVeiculo17 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (conn != null) {
                ...
                request.setAttribute("success", "Veículo arrumado com sucesso!");
            } else {
        ...
        request.getRequestDispatcher("ArrumarVeiculo17.jsp").forward(request, response);
    }
}
