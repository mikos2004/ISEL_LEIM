...
@WebServlet("/EscolherReserva41")
public class EscolherReserva41 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("EscolherReserva41.jsp").forward(request, response);
    }
}
