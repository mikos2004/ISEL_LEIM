...
@WebServlet("/LevantarVeiculo31")
public class LevantarVeiculo31 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (conn != null && numeroCartaConducao != null && !numeroCartaConducao.trim().isEmpty()) {
        ...
        request.setAttribute("numeroCartaConducao", numeroCartaConducao);
        System.out.println(numeroCartaConducao);
