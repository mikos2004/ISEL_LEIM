...
@WebServlet("/AtualizarCliente12")
public class AtualizarCliente12 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (numeroFiscal == null || campoAtualizar == null || novoValor == null) {
            request.setAttribute("error", "Dados inválidos ou ausentes.");
            request.getRequestDispatcher("AtualizarCliente12.jsp").forward(request, response);
            return;
        }
        ...
        try {
            ...
            if (conn != null) {
                Auxiliar.updateCampoCliente(conn, numeroFiscal, campoAtualizar, novoValor);                
