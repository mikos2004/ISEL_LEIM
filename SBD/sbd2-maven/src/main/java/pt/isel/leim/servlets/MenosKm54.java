...
@WebServlet("/MenosKm54")
public class MenosKm54 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (conn != null && dataInicialFormatada != null && dataFinalFormatada != null) {
                ...
                try {
                    ...
                    Auxiliar.ranking10MenorQuilometragem(conn, dataInicialFormatada, dataFinalFormatada);
                } finally {
        ...
        request.getRequestDispatcher("Gerente54.jsp").forward(request, response);
    }
}
