...
<body>
    <div class="container">
        ...
        <form action="AtualizarCliente12" method="post">
            <!-- Input para o NIF -->
            <label for="numeroFiscal">Digite o NIF do Cliente:</label>
            ...
            <select name="campoAtualizar" id="campoAtualizar" required>
                ...
                <option value="preferenciasLinguisticasECulturais">Línguas</option>
